...
public class CommandHelpPlayer {
    ...
    public static String send() {
        ...
        helpMessage.append(prefixCmd).append("map play").append(separator).append("Join a game.\n")
                .append(prefixCmd).append("map leave").append(separator).append("Leave your current game.\n")
                .append(prefixCmd).append("map stats").append(separator).append("Show your stats.\n");
